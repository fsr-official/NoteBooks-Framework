            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch('/api/gh.js', {
                            ...
                            body: JSON.stringify(__assign({ action: action }, params))
                        })];
                case 1:
                    response = _a.sent();
                ...
                case 2:
                    data = _a.sent();
                    if (!response.ok) {
                        return [2 /*return*/, { ok: false, error: data.error || "API error (".concat(response.status, ")"), status: response.status }];
                    }
                    return [2 /*return*/, { ok: true, data: data }];
                case 3:
                    e_1 = _a.sent();
                    console.error('[ghProxy] Network error:', e_1);
