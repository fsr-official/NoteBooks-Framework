...
const THEME_PRESETS = {
    ...
    classic: { dark: { accent: '#79c0ff', surface: '#262b32', surfaceStrong: '#30363d', surfaceMuted: '#20252b', inputBg: '#1d2228', cardBg: '#2b3138', cardHover: '#343b44', link: '#79c0ff', focus: '#58a6ff', accentSubtle: 'rgba(88,166,255,.16)', accent: '#79c0ff', text: '#e6edf3', textMuted: '#aab4c0', code: '#161b22', codeText: '#e6edf3', overlay: 'rgba(13,17,23,.82)', code: '#161b22', font: 'system-ui', bg: '#1b1f24', panel: '#2b3138', border: '#4b5563', borderSubtle: 'rgba(139,148,158,.35)', radius: '6px', density: '.94', shadow: '0 8px 24px rgba(0,0,0,.28)', texture: 'none', heading: 'system-ui' }, light: { accent: '#0969da', surface: '#ffffff', text: '#1f2328', code: '#f6f8fa', font: 'system-ui', bg: '#f6f8fa', panel: '#ffffff', border: '#d0d7de', radius: '6px', density: '.94', shadow: '0 1px 2px rgba(31,35,40,.08)', texture: 'none', heading: 'system-ui' } }
};
let themeMode = 'dark';
